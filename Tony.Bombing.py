...
def bann_text():
    clr()
    logo = """
   TTTTTT    BBBB   OOO  M   M    BBBB  DDD      77777  11  
     TT      B   B O   O MM MM    B   B D  D        7  111  
     TT      BBBB  O   O M M M    BBBB  D  D ---   7    11  
..   TT   .. B   B O   O M   M .. B   B D  D       7    11  
..   TT   .. BBBB   OOO  M   M .. BBBB  DDD        7   11l1 
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("TBomb was created by TONY")
